...
import { patientListDB, selPatientDB } from '../../../atoms/접수_수납/Recoils_접수_수납DB';
    ...
    <div className="PatientSearchBar">
      ...
      <div className="PatientSearchBar_PatientInfo">
        {selectedPatientDB !== undefined ? (
          <div className="PatientSearchBar_PatientInfo_info">
            ...
            <div className="PatientSearchBar_PatientInfo_info_name">{selectedPatientDB.pt_nm}</div>
            <div className="PatientSearchBar_PatientInfo_info_id">no.{selectedPatientDB.pid}</div>
            <div className="PatientSearchBar_PatientInfo_info_sexAge">
              ({selectedPatientDB.sex_cd}&#47;{calcAge(selectedPatientDB.dobr)}세)
            </div>
            ...
            <div style={{borderRight: 'black 1px solid', width: 3, paddingRight: 1}}>
              &nbsp;
            </div>
          </div>
        ) : (
      ...
      <div className="PatientSearchBar_SearchBox">
        <div className="PatientSearchBar_SearchBox_searchBox">
          ...
          />
          <img src={loupe} alt="search" width="15px" height="15px" style={{position:'absolute',left:1690,top:18}}/>
        </div>
        ...
        <div className="PatientSearchBar_SearchBox_initBtn">
          {/* 환자 초기화부분 */}
          <OBTButton labelText={"초기화"} width= '80px' onClick={initSelectedPatient} imageUrl={undo}/>
        </div>
      </div>
    </div>
  );
